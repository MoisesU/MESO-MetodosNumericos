 ...
 * @author MoisésUlises
 */
public class FXMLInterpolSplinController implements Initializable {
    ...
    private Scilab sci;
    private final File interpolacionSplines = new File(Config.getFolder()+"interpolacionSplines.sce");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            sci.exec(interpolacionSplines);
        } catch (FileNotFoundException ex) {
            System.err.println("Error: archivo de scripts/interpolacionSplines.sce no encontrado \n"+ex.getMessage());
        }
    ...
    private void calc(ActionEvent event) {
        if(funct.size()<2){
            ...
            try {
                ...
                sci.exec("res = interpolSplin(f, "+tfValue.getText()+")");
