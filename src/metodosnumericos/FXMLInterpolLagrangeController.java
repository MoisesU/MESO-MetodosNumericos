 ...
 * @author MoisésUlises
 */
public class FXMLInterpolLagrangeController implements Initializable {
    ...
    private Scilab sci;
    private final File interpolacionLagrange = new File(Config.getFolder()+"interpolacionLagrange.sce");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            sci.exec(interpolacionLagrange);
        } catch (FileNotFoundException ex) {
            System.err.println("Error: archivo de scripts/interpolacionLagrange.sce no encontrado \n"+ex.getMessage());
        }
    ...
    private void calc(ActionEvent event) {
        if(funct.size()<2){
            ...
            try {
                ...
                sci.exec("res = interpolLagrange(f, "+g+","+tfValue.getText()+")");
