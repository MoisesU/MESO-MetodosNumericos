 ...
 * @author MoisésUlises
 */
public class FXMLSimpson38Controller implements Initializable {
    ...
    private Scilab sci;
    private final File simpson38 = new File(Config.getFolder()+"simpson38.sce");
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            System.err.println("Error: archivo de scripts/simpson38.sce no encontrado \n"+ex.getMessage());
        }
    }    
            ...
            try{
                ...
                if(!t.isEvenNumber(r)){
                    if(sci.exec("function [y]=f(x), y="+tfFunc.getText()+", endfunction")){
                        sci.exec("[result, tab] = simp38(f, "+tfLimA.getText()+","+tfLimB.getText()+", "+r+")");
                    ...
                    OptionPane.showMessageDialog(null, "Este método solo funciona con intervalos impares");
                }
            }
