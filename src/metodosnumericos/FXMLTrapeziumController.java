 ...
 * @author MoisésUlises
 */
public class FXMLTrapeziumController implements Initializable {
    ...
    private Scilab sci;
    private final File trapecio = new File(Config.getFolder()+"trapecio.sce");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            System.err.println("Error: archivo de scripts/trapecio.sce no encontrado \n"+ex.getMessage());
        }
    }    
        ...
        if(tfLimA.getText().equals("")||tfLimB.getText().equals("")||tfFunc.getText().equals("")||tfSquares.getText().equals("")){
            ...
            try{
                ...
                if(sci.exec("function [y]=f(x), y="+tfFunc.getText()+", endfunction")){
                    sci.exec("[result, tab] = trapecio(f, "+tfLimA.getText()+","+tfLimB.getText()+", "+r+")");
