 ...
 * @author MoisésUlises
 */
public class FXMLGaussSeidelController implements Initializable {
    ...
    private Scilab sci;
    private final File gaussSeidel = new File(Config.getFolder()+"gaussSeidel.sce");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            sci.exec(gaussSeidel);
        } catch (FileNotFoundException ex) {
            System.err.println("Error: archivo de scripts/gaussSeidel.sce no encontrado \n"+ex.getMessage());
        }
    }    
        ...
        if(check){
            ...
            if(!check){
                ...
                try{
                    ...
                    sci.exec("X = gaussSeidel(A,B, "+Config.getFix()+")");
